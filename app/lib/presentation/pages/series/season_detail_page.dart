        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              sized30,
              WidgetInformationBox(width: width, text: widget.season.seasonDescription, title: description),
              sized30,
              const Center(child: Text(episodes, style: commingSoonTitleStyle)),
              ...widget.season.episodes.map((item) {
                return GestureDetector(
                  onTap: () { Navigator.push(context, MaterialPageRoute(builder: (context) { return EpisodeDetailPage(episode: item); })); },
