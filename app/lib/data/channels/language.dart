...
class Language {
  ...
  Language copyWith({ String? code, String? name }) => Language(code: code ?? this.code, name: name ?? this.name);

  Map<String, dynamic> toMap() => { 'code': code, 'name': name };

  factory Language.fromMap(Map<String, dynamic> map) => Language(code: map['code'], name: map['name']);
