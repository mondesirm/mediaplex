...
class Episode {
  ...
  const Episode({ required this.episodeName, required this.episodeDescription, required this.episodeUrl, required this.episodeLogo });

  Episode copyWith({ String? episodeName, String? episodeDescription, String? episodeUrl, String? episodeLogo }) {
    return Episode(
  ...
  @override
  String toString() => 'Episode(episodeName: $episodeName, episodeDescription: $episodeDescription, episodeUrl: $episodeUrl, episodeLogo: $episodeLogo)';
  ...
  @override
  int get hashCode => episodeName.hashCode ^ episodeDescription.hashCode ^ episodeUrl.hashCode ^ episodeLogo.hashCode;
}