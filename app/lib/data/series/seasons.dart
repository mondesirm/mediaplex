...
class Seasons {
  ...
  const Seasons({ required this.seasonName, required this.seasonDescription, required this.seasonLogo, required this.episodes });

  Seasons copyWith({ String? seasonName, String? seasonDescription, String? seasonLogo, List<Episode>? episodes }) {
    return Seasons(
  ...
  @override
  String toString() => 'Seasons(seasonName: $seasonName, seasonDescription: $seasonDescription, seasonLogo: $seasonLogo, episodes: $episodes)';
  ...
  @override
  int get hashCode => seasonName.hashCode ^ seasonDescription.hashCode ^ seasonLogo.hashCode ^ episodes.hashCode;
}